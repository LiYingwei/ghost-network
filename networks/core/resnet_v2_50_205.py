...
# _CHECKPOINT_NAME = 'self_trained_resnet_v2_50/model205/model.ckpt-98010'
_CHECKPOINT_NAME = 'self_trained_resnet_v2_50/model205/model.ckpt-112612'
...
def func(inputs, num_classes=None, is_training=False, global_pool=True,
         output_stride=None, reuse=None, scope='resnet_v2_50_205'):
